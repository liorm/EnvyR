...
namespace EnvyR.Server
{
    class Application : AsyncApplication, IApp
    {
        ...
        private readonly List<CameraManager> m_managers = new List<CameraManager>();
        ...
        protected override bool OnInit()
        {
            ...
            CameraConfiguration testConfig = new CameraConfiguration(@"http://213.8.143.168/100fmAudio");
            var testManager = new CameraManager(testConfig);
            m_managers.Add(testManager);

            testManager.Start();

            Task.Delay(10000).ContinueOnCurrent((task) => testManager.Dispose());
